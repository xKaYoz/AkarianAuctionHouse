...
public class Updater {
    ...
    private void download() {
        ...
        try {
            ...
            plugin.getLogger().log(Level.INFO, url.toString());
            ...
            if (restart && result != Result.FAILED) {
                Bukkit.getScheduler().runTask(AuctionHouse.getInstance(), () -> Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "restart"));
            }
        }
    }
